        ...
        <div className={styles['CreateAccount-container']}>
            ...
            <form action="/" className={styles.form}>
                <div>
                    ...
                    <input type="text" id="name" placeholder="Joiver" className={styles['input input-name']} />
                    <label htmlFor="email" className={styles.label}>Email</label>
                    <input type="text" id="email" placeholder="gjoiver@example.com" className={styles['input input-email']} />
